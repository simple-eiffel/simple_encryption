...
extern void F344_3456(EIF_REFERENCE);
extern void F344_3457(EIF_REFERENCE);
...
EIF_TYPED_VALUE F344_3453 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 343, Current, 0, 0, 4298);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(343, Current, 4298);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F344_3455 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 343, Current, 0, 0, 4300);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(343, Current, 4300);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F344_3456 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 343, Current, 0, 0, 4301);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(343, Current, 4301);
	RTIV(Current, RTAL);
...
void F344_3457 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 343, Current, 0, 0, 4302);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(343, Current, 4302);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 343, Current, 2, 1, 4303);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(343, Current, 4303);
	{
