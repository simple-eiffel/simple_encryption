...
extern EIF_TYPED_VALUE F766_3453(EIF_REFERENCE);
extern EIF_TYPED_VALUE F766_3454(EIF_REFERENCE);
extern EIF_TYPED_VALUE F766_3455(EIF_REFERENCE);
extern void F766_3456(EIF_REFERENCE);
extern void F766_3457(EIF_REFERENCE);
extern EIF_TYPED_VALUE F766_3459(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F766_3453 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 765, Current, 0, 0, 4346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(765, Current, 4346);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F766_3454 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F766_3455 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 765, Current, 0, 0, 4348);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(765, Current, 4348);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F766_3456 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 765, Current, 0, 0, 4349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(765, Current, 4349);
	RTIV(Current, RTAL);
...
void F766_3457 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 765, Current, 0, 0, 4350);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(765, Current, 4350);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F766_3459 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 765, Current, 2, 1, 4351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(765, Current, 4351);
	{
