...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F21_366);
	dtype = Dtype(Current);
	...
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(371, dtype))(Current)).it_c1);
...
EIF_TYPED_VALUE F21_369 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 385);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F21_372 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
