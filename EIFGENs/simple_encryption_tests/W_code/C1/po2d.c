...
static const EIF_TYPE_INDEX egt_1_2 [] = {0xFF01,330,1,0xFFFF};
...
static const EIF_TYPE_INDEX egt_13_2 [] = {0xFF01,619,272,0xFFFF};
...
static const struct desc_info desc_2[] = {
	...
	{EIF_NON_GENERIC(0x0209 /*260*/), 33, 8},
	{EIF_GENERIC(egt_13_2), 34, 0},
	{EIF_NON_GENERIC(0x0209 /*260*/), 35, 12},
	{EIF_NON_GENERIC(0x0209 /*260*/), 36, 16},
	{EIF_NON_GENERIC(0x0209 /*260*/), 37, 20},
};
void Init2(void)
{
	IDSC(desc_2, 0, 1);
	IDSC(desc_2 + 1, 4, 1);
	IDSC(desc_2 + 32, 380, 1);
}
