...
extern void F150_1743(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F150_1743 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 149, Current, 8, 1, 1752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tr1 = RTLNSP2(RTWCT(1537, dtype, Dftype(Current)).id,0,ui4_2,sizeof(EIF_INTEGER_32), EIF_TRUE);
