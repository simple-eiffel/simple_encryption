...
extern EIF_TYPED_VALUE F1021_3500(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1021_3500 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1020, Current, 0, 0, 4748);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1020, Current, 4748);
	RTIV(Current, RTAL);
	RTHOOK(1);
