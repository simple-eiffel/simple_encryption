/*
 * Code for class CASE_INSENSITIVE_STRATEGY
 */
...
extern EIF_TYPED_VALUE F65_1126(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F65_1127(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CASE_INSENSITIVE_STRATEGY}.text_to_number */
EIF_TYPED_VALUE F65_1126 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_n1
	...
	RTEAA(l_feature_name, 64, Current, 0, 1, 1162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
/* {CASE_INSENSITIVE_STRATEGY}.number_to_text */
EIF_TYPED_VALUE F65_1127 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
