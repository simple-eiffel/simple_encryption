...
extern EIF_TYPED_VALUE F664_3453(EIF_REFERENCE);
extern EIF_TYPED_VALUE F664_3454(EIF_REFERENCE);
extern EIF_TYPED_VALUE F664_3455(EIF_REFERENCE);
extern void F664_3456(EIF_REFERENCE);
extern void F664_3457(EIF_REFERENCE);
extern EIF_TYPED_VALUE F664_3459(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F664_3453 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 663, Current, 0, 0, 4334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(663, Current, 4334);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F664_3454 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F664_3455 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 663, Current, 0, 0, 4336);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(663, Current, 4336);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
...
void F664_3456 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 663, Current, 0, 0, 4337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(663, Current, 4337);
	RTIV(Current, RTAL);
...
void F664_3457 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 663, Current, 0, 0, 4338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(663, Current, 4338);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
...
EIF_TYPED_VALUE F664_3459 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 663, Current, 2, 1, 4339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(663, Current, 4339);
	{
