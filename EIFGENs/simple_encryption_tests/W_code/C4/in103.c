...
extern EIF_TYPED_VALUE F103_1526(EIF_REFERENCE);
extern void F103_1527(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 102, Current, 1, 0, 1532);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1426, dtype))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 102, Current, 0, 0, 1533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
RTOID (F103_1526)
EIF_TYPED_VALUE F103_1526 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 102, Current, 0, 0, 1534);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(102, Current, 1534);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800009A, 0,0); /* Result */
...
void F103_1527 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 102, Current, 0, 1, 1535);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(102, Current, 1535);
...
{
	GTCX
	RTOTS (1525,F103_1525)
	RTOTS (1526,F103_1526)
}
