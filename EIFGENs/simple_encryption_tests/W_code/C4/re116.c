...
extern EIF_TYPED_VALUE F116_1594(EIF_REFERENCE);
extern EIF_TYPED_VALUE F116_1595(EIF_REFERENCE);
...
/* {RESCUE_FAILURE}.code */
EIF_TYPED_VALUE F116_1594 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 115, Current, 0, 0, 1602);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1586, 150))(Current)).it_i4);
...
/* {RESCUE_FAILURE}.tag */
RTOID (F116_1595)
EIF_TYPED_VALUE F116_1595 (EIF_REFERENCE Current)
{
	GTCX
