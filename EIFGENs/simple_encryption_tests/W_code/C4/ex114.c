...
extern EIF_TYPED_VALUE F114_1590(EIF_REFERENCE);
extern EIF_TYPED_VALUE F114_1591(EIF_REFERENCE);
...
EIF_TYPED_VALUE F114_1590 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 113, Current, 0, 0, 1598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1592, 150))(Current)).it_i4);
...
RTOID (F114_1591)
EIF_TYPED_VALUE F114_1591 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 113, Current, 0, 0, 1599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
