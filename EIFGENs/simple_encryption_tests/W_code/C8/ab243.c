...
extern EIF_TYPED_VALUE F243_4402(EIF_REFERENCE);
extern void F243_7330(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F243_4402 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 242, Current, 0, 0, 7359);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(242, Current, 7359);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F243_7330 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 242, Current, 0, 7329);
	RTSA(dtype);
	RTME(dtype, 0);
